...
final class App
{
	...
	private static function dispatch(string $method, string $path): void
	{
		$routes = [
			...
			['POST', '#^/tablero/columnas$#', [Controllers\BoardController::class, 'columnsStore']],
			['POST', '#^/tablero/columnas/([a-z0-9-]+)/mover$#', [Controllers\BoardController::class, 'columnsShift']],
			['POST', '#^/tablero/columnas/([a-z0-9-]+)/eliminar$#', [Controllers\BoardController::class, 'columnsDelete']],
			['POST', '#^/tablero/columnas/([a-z0-9-]+)$#', [Controllers\BoardController::class, 'columnsUpdate']],
			...
			['GET', '#^/contabilidad$#', [Controllers\AccountingController::class, 'index']],
			['POST', '#^/contabilidad/tasa$#', [Controllers\AccountingController::class, 'saveRate']],
			['POST', '#^/contabilidad/comisiones$#', [Controllers\AccountingController::class, 'saveCommissions']],
			['POST', '#^/contabilidad/obligaciones/(\d+)/eliminar$#', [Controllers\AccountingController::class, 'deleteObligation']],
			['POST', '#^/contabilidad/obligaciones/(\d+)$#', [Controllers\AccountingController::class, 'updateObligation']],
			['POST', '#^/contabilidad/obligaciones$#', [Controllers\AccountingController::class, 'storeObligation']],
			['GET', '#^/facturas$#', [Controllers\InvoiceController::class, 'index']],
			['POST', '#^/facturas/venta/(\d+)/eliminar$#', [Controllers\InvoiceController::class, 'deleteSale']],
			['POST', '#^/facturas/venta/(\d+)/pagar$#', [Controllers\InvoiceController::class, 'pay']],
			['POST', '#^/facturas/venta/(\d+)$#', [Controllers\InvoiceController::class, 'updateSale']],
			['POST', '#^/facturas/compra/(\d+)/eliminar$#', [Controllers\InvoiceController::class, 'deletePurchase']],
			['POST', '#^/facturas/compra/(\d+)$#', [Controllers\InvoiceController::class, 'updatePurchase']],
